...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-12">
        <h1 class="py-5 fw-bold text-secondary">Update User</h1>
          <form action="{{ route('updateUser', $data->id) }}" method="POST" class="my-5">
            @csrf
            @method('PUT')
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-warning btn-lg w-100 mt-3" >Update User</button>
          </form>
        </div>
      </div>
    </div>
